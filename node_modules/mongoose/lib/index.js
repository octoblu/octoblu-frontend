 ...
 *
 *     // with mongodb:// URI
 *     db = mongoose.createConnection('mongodb://[user]:[password]@localhost:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb://[user]:[password]@localhost:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb://[user]:[password]@localhost:port/database,mongodb://anotherhost:port,mongodb://yetanother:port');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb://[user]:[password]@localhost:port/database,mongodb://anotherhost:port,mongodb://yetanother:port', opts);
 *
 ...
 *
 *     // replica sets
 *     var uri = 'mongodb://[user]:[password]@localhost:port/database,mongodb://anotherhost:port,mongodb://yetanother:port';
