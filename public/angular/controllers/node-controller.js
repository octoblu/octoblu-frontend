angular.module("octobluApp").controller("NodeController", function($scope, $state, $window, NodeService, NotifyService, DeviceLogo) {
  "use strict"
  ...
  $scope.nextStepUrl = function(node) {
    if (!node) {
      return NotifyService.notifyError("Unable to navigate to node")
    }
    var sref
    var params = {}
