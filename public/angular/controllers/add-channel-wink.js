...
.controller('addChannelWinkController', function($scope, $state, $http, nodeType, userService, channelService, AuthService) {
  var channelPromise;
  ...
  $scope.activate = function(){
    ...
    channelPromise.then(function(channel){
      $http.post('/api/wink/auth', profile).then(function(){
