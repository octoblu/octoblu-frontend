angular.module('e2eApp')
    .controller('connectorController', function($scope, $http, $location, $modal, $log, $q, $state,
...
//    }
    ...
    .controller('connectorAdvancedController', function($scope, $http, $location, $modal, $log, $q, $modal, $state,
                                                ownerService, deviceService, channelService) {
