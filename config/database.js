var config = {
    development: {
        ...
        redisSessionUrl: process.env.REDIS_SESSION_URI || 'redis://localhost/octoblu-session'
    },
    test: {
    ...
    production: {
        ...
        redisSessionUrl: 'redis://meshblu-redis.csy8op.0001.usw2.cache.amazonaws.com/octoblu-session'
    }
};
