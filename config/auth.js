...
module.exports = {
  ...
  'facebookAuth' : {
    ...
    'callbackURL'   : 'http://meshines.jit.su/auth/facebook/callback'
  },

  'twitterAuth' : {
    'consumerKey'     : '2GFvhpzG7PzDAiommSLIg',
    'consumerSecret'  : 'PMftByICxSfbvf7rPqfivAocDE25a0EqZGDkMbKh6Q',
    'callbackURL'     : 'http://meshines.jit.su/auth/twitter/callback'
  },

  'googleAuth' : {
    'clientID'    : '541059729530-bbt3n8qh5s8c8m5dm7dh6gojiqqrfrbg.apps.googleusercontent.com',
    'clientSecret'  : 'SVTqhJ7RtsK6zqRcKUZrjxM6',
    'callbackURL'   : 'http://meshines.jit.su/auth/google/callback'
  },
  'port' : 80
